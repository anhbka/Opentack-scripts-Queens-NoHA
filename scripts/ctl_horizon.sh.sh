...
<html>
<head>
<META HTTP-EQUIV="Refresh" Content="0.5; URL=http://$CTL1_IP_NIC3/dashboard">
</head>
<body>
...
echo "URL: http://$CTL1_IP_NIC3/dashboard"

...
function keystone_bootstrap {
          ...
          --bootstrap-admin-url http://$CTL1_IP_NIC3:5000/v3/ \
          --bootstrap-internal-url http://$CTL1_IP_NIC3:5000/v3/ \
          --bootstrap-public-url http://$CTL1_IP_NIC3:5000/v3/ \
...
export OS_AUTH_URL=http://$CTL1_IP_NIC3:5000/v3
...
echocolor "Thuc hien bootstrap cho keystone"
sleep 3
keystone_bootstrap

...
function khai_bao_host {
        ...
        echo "$CINDER1_IP_NIC1 cinder" >> /etc/hosts
        scp /etc/hosts root@$COM1_IP_NIC3:/etc/
        scp /etc/hosts root@$COM2_IP_NIC3:/etc/
}
...
function install_memcached() {
        ...
        sed -i "s/-l 127.0.0.1,::1/-l 127.0.0.1,::1,$CTL1_IP_NIC3/g" /etc/sysconfig/memcached

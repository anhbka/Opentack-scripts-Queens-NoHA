...
function cin_cinder_config {
        ...
        cp $cin_cinder_conf $cin_cinder_conf.orig
				...
				ops_edit $cin_cinder_conf DEFAULT my_ip $CINDER1_IP_NIC3
				ops_edit $cin_cinder_conf DEFAULT control_exchange cinder
				ops_edit $cin_cinder_conf DEFAULT osapi_volume_listen  \$my_ip
				ops_edit $cin_cinder_conf DEFAULT control_exchange cinder
				ops_edit $cin_cinder_conf DEFAULT glance_api_servers http://$CTL1_IP_NIC3:9292
				ops_edit $cin_cinder_conf DEFAULT glance_api_version 2
				ops_edit $cin_cinder_conf DEFAULT enabled_backends lvm
				
				ops_edit $cin_cinder_conf database connection  mysql+pymysql://cinder:$PASS_DATABASE_CINDER@$CTL1_IP_NIC3/cinder

				ops_edit $cin_cinder_conf keystone_authtoken auth_uri http://$CTL1_IP_NIC3:5000
				ops_edit $cin_cinder_conf keystone_authtoken auth_url http://$CTL1_IP_NIC3:5000
				ops_edit $cin_cinder_conf keystone_authtoken memcached_servers $CTL1_IP_NIC3:11211
				...
				ops_edit $cin_cinder_conf oslo_messaging_rabbit rabbit_host $CTL1_IP_NIC3
